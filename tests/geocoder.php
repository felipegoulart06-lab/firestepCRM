...
expect(!str_contains($index, '/master/configuracoes/leaflet'), 'painel master não configura mais o Leaflet');
expect(!str_contains($tecnico, 'leaflet_token') && !str_contains($tecnico, 'Token do geocoder'), 'ajustes técnicos sem token de mapa');
